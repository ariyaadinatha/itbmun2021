    ...
    <section class="registration-body" id='body'>
        <div class="registration-wrapper">
            ...
            <div class="form-page is-active registration-card-wrapper" id='form-landing'>
                ...
                <a class='registration-form__delegate-choice delegate' target="_blank" href="https://form.jotform.me/93293074744463">
                    <h2>INDIVIDUAL DELEGATE</h2>
                </a>
                <a class='registration-form__delegate-choice delegation' target="_blank" href="https://form.jotform.me/93302695827465">
                    <h2>DELEGATION</h2>
                </a>
            </div>
